        ...
        >
          {domains.map((domain, idx) => (
            ...
            >
              ...
              <div className="absolute -bottom-10 -right-10 text-9xl text-red-600/5 dark:text-red-500/10 group-hover:text-red-600/10 dark:group-hover:text-red-500/20 transition-colors pointer-events-none">
